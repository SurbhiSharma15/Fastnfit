    ...
    <div>
      <nav className={styles.navbar}>
        <div className={styles.name}>
          <Link to='/'> <img className='crossfit-logo' src="https://res.cloudinary.com/dycitvrpg/image/upload/v1681382796/logo_xx6npu.png" alt="logo" /> </Link>
        </div>
          ...
          <ul id="primary-menu" className={`${styles.menu} ${styles.navMenu}`}>
            ...
            <li className={styles.menuItem}>
              <Link className={styles.navLink} to="/profile">{
                window.outerWidth>1200?<img className='user-logo' src={user?.avatar} alt="" />:"Profile"
              }</Link>
            </li>
